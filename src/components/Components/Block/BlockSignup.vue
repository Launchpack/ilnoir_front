...
<div>
  ...
  <div :style="[contentStyle,pagePadding]">
    <!-- 본인 인증 메시지 -->
  ...
  <div :style="pagePadding" style="padding:32px 16px" v-if="!isVerify">
    <!--내정보수정 버튼-->
    <div class="unselect" :style="buttonCustom" style="margin-bottom:16px" @click="sign">가입하기</div>
    <div @click="clickBack" :style="[brandBgColor.sub,radius]" class="size-14 weight-500 unselect"
      style="width:100%;height:48px;line-height:48px;text-align:center">취소</div>
  </div>
</div>
</template>
<script>
