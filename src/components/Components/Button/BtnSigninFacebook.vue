...
<script>
  export default {
    ...
    methods: {
      fbLogin() {
        location.href = 'https://www.facebook.com/v2.10/dialog/oauth?client_id=%s&redirect_uri=%s'
