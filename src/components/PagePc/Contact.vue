...
<script>
  import ContactPc from '@/components/Pages/ContactPc'

  export default {
    components: { ContactPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25404, "name": "ContactPc", "template_name": "", "route_pc__id": 10620, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
