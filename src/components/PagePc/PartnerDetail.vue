...
<script>
  import PartnerDetailPc from '@/components/Pages/PartnerDetailPc'

  export default {
    components: { PartnerDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25346, "name": "PartnerDetailPc", "template_name": "", "route_pc__id": 10610, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
