...
<script>
  import MyInquiryPc from '@/components/Pages/MyInquiryPc'

  export default {
    components: { MyInquiryPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25430, "name": "MyInquiryPc", "template_name": "", "route_pc__id": 10626, "activated": true, "login_required": true, "grade": 1, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
