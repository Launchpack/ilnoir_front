...
<script>
  import ReviewRegPc from '@/components/Pages/ReviewRegPc'

  export default {
    components: { ReviewRegPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25420, "name": "ReviewRegPc", "template_name": "", "route_pc__id": 10624, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
