...
<script>
  import ContactRegPc from '@/components/Pages/ContactRegPc'

  export default {
    components: { ContactRegPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25410, "name": "ContactRegPc", "template_name": "", "route_pc__id": 10622, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
