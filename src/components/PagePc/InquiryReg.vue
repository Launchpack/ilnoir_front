...
<script>
  import InquiryRegPc from '@/components/Pages/InquiryRegPc'

  export default {
    components: { InquiryRegPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25425, "name": "InquiryRegPc", "template_name": "", "route_pc__id": 10625, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
