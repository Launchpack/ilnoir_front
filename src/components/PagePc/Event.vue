...
<script>
  import EventPc from '@/components/Pages/EventPc'
  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25394, "name": "EventPc", "template_name": "", "route_pc__id": 10618, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
