...
<script>
  import TrainingPc from '@/components/Pages/TrainingPc'

  export default {
    components: { TrainingPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25759, "name": "TrainingPc", "template_name": "", "route_pc__id": 10687, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
