...
<script>
  import ProductDetailPc from '@/components/Pages/ProductDetailPc'

  export default {
    components: { ProductDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25373, "name": "ProductDetailPc", "template_name": "", "route_pc__id": 10614, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
