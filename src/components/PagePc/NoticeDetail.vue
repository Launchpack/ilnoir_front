...
<script>
  import NoticeDetailPc from '@/components/Pages/NoticeDetailPc'

  export default {
    components: { NoticeDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25389, "name": "NoticeDetailPc", "template_name": "", "route_pc__id": 10617, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
