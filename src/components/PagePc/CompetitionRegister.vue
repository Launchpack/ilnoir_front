...
<script>
  import CompetitionRegisterPc from '@/components/Pages/CompetitionRegisterPc'

  export default {
    components: { CompetitionRegisterPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25812, "name": "CompetitionRegisterPc", "template_name": "", "route_pc__id": 10692, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
