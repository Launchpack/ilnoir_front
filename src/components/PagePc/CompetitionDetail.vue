...
<script>
  import CompetitionDetailPc from '@/components/Pages/CompetitionDetailPc'

  export default {
    components: { CompetitionDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25788, "name": "CompetitionDetailPc", "template_name": "", "route_pc__id": 10691, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
