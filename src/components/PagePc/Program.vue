...
<script>
  import ProgramPc from '@/components/Pages/ProgramPc'

  export default {
    components: { ProgramPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25753, "name": "ProgramPc", "template_name": "", "route_pc__id": 10685, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
