...
<script>
  import EventDetailPc from '@/components/Pages/EventDetailPc'

  export default {
    components: { EventDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25399, "name": "EventDetailPc", "template_name": "", "route_pc__id": 10619, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
