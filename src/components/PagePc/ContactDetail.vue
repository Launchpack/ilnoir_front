...
<script>
  import ContactDetailPc from '@/components/Pages/ContactDetailPc'

  export default {
    components: { ContactDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25407, "name": "ContactDetailPc", "template_name": "", "route_pc__id": 10621, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
