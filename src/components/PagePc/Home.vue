...
<script>
  import HomePc from '@/components/Pages/HomePc'
  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25444, "name": "HomePc", "template_name": "", "route_pc__id": 10630, "activated": true, "login_required": false, "grade": 0, "partner_grade": 0, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
