...
<script>
  import TrainingDetailPc from '@/components/Pages/TrainingDetailPc'

  export default {
    components: { TrainingDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25774, "name": "TrainingDetailPc", "template_name": "", "route_pc__id": 10688, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
