...
<script>
  import MyReviewPc from '@/components/Pages/MyReviewPc'

  export default {
    components: { MyReviewPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25414, "name": "MyReviewPc", "template_name": "", "route_pc__id": 10623, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
