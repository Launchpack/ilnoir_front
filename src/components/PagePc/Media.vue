...
<script>
  import MediaPc from '@/components/Pages/MediaPc'
  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25690, "name": "MediaPc", "template_name": "", "route_pc__id": 10677, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
