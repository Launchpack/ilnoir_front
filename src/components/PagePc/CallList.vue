...
<script>
  import CallListPc from '@/components/Pages/CallListPc'

  export default {
    components: { CallListPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25438, "name": "CallListPc", "template_name": "", "route_pc__id": 10629, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
