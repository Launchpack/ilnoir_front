...
<script>
  import MediaDetailPc from '@/components/Pages/MediaDetailPc'

  export default {
    components: { MediaDetailPc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25697, "name": "MediaDetailPc", "template_name": "", "route_pc__id": 10678, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
