...
<script>
  import ProfilePc from '@/components/Pages/ProfilePc'

  export default {
    components: { ProfilePc },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25322, "name": "ProfilePc", "template_name": "", "route_pc__id": 10607, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
