...
<script>
  import ReviewReg from '@/components/Pages/ReviewReg'

  export default {
    components: { ReviewReg },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25417, "name": "ReviewReg", "template_name": "", "route__id": 10624, "activated": true, "login_required": false, "grade": 0, "partner_grade": 0, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
