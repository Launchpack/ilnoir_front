  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25362, "name": "Product", "template_name": "", "route__id": 10613, "activated": true, "login_required": false, "grade": 0, "partner_grade": 0, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
