...
<script>
  import CompetitionRegister from '@/components/Pages/CompetitionRegister'

  export default {
    components: { CompetitionRegister },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25811, "name": "CompetitionRegister", "template_name": "", "route__id": 10692, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
