...
<script>
  import InquiryReg from '@/components/Pages/InquiryReg'

  export default {
    components: { InquiryReg },
    data() {
      return {
        enablePage: false,
        componentName: '/',
        category_id: 0,
        category: {},
        boards: [{"id": 25423, "name": "InquiryReg", "template_name": "", "route__id": 10625, "activated": true, "login_required": true, "grade": 1, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
