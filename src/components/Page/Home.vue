  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25439, "name": "Home", "template_name": "", "route__id": 10630, "activated": true, "login_required": false, "grade": 1, "partner_grade": 0, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
