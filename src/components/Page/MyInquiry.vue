  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25427, "name": "MyInquiry", "template_name": "", "route__id": 10626, "activated": true, "login_required": true, "grade": 1, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
