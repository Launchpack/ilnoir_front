  ...
  export default {
    ...
    data() {
      return {
        ...
        category_id: 0,
        category: {},
        boards: [{"id": 25689, "name": "Media", "template_name": "", "route__id": 10677, "activated": true, "login_required": false, "grade": null, "partner_grade": null, "category1": null, "category2": null, "category3": null}]
      }
    },
    watch: {
      componentName(n) {
